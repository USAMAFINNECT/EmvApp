...
public interface OnEmvProcessListener {
    ...
    /**请求提示信息*/
    void requestTipsConfirm(String msg) throws android.os.RemoteException;
    /**请求多应用选择*/
    void requestAidSelect(int times, String[] aids) throws android.os.RemoteException;
    /**请求确认是否使用电子现金*/
    ...
    /** 请求导入PIN */
    void requestImportPin(int type, boolean lasttimeFlag, String amt) throws android.os.RemoteException;
    /** 请求身份认证 */
    void requestUserAuth(int certype, String certnumber) throws android.os.RemoteException;
    /**请求联机*/
